#ifndef PARCKING_LOT_MANEGMENT__SYSTEM_PARKINGSESSION_H
#define PARCKING_LOT_MANEGMENT__SYSTEM_PARKINGSESSION_H
...
#endif //PARCKING_LOT_MANEGMENT__SYSTEM_PARKINGSESSION_H
